...
<head>
    ...
    <title>Decoración de Galletas | Ellado Dulce</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="detalle-galletas.css">
</head>
<body>
    ...
    <main class="detalle-page">
        ...
        <section class="detalle-layout">
            ...
            <div class="info-area">
                ...
                <p class="description">
                    Aprende a decorar galletas con glasé real, colores vibrantes
                    y diseños únicos. Esta actividad incluye materiales, galletas
                    y una guía paso a paso para que cada participante cree sus
                    propias decoraciones dulces.
                </p>
                ...
                <section class="option-box">
                    ...
                    <div class="schedule-options">
                        <button type="button" class="schedule-option selected" data-horario="Sábado 11:00 a.m.">
                            <strong>Sábado</strong>
                            <small>11:00 a.m.</small>
                        </button>

                        <button type="button" class="schedule-option" data-horario="Domingo 2:00 p.m.">
                ...
                <section class="option-box">
                    ...
                    <input 
                        type="text" 
                        id="notas" 
                        placeholder="Ej: alergias, edad del participante, colores preferidos..."
                    >
                </section>
                ...
                <section class="summary-box">
                    <div class="summary-top">
                        ...
                        <div class="summary-price">
                            <strong id="subtotal">$15.00</strong>
                    ...
                    <div class="confirmation-box hidden" id="confirmationBox">
                        ...
                        <strong id="confirmationNumber">ED-GAL-0000</strong>
    ...
    <script src="detalle-galletas.js"></script>
</body>
</html>