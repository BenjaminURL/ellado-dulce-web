...
<head>
    ...
    <title>Mini Galletas | El Lado Dulce</title>
    ...
    <main>
        ...
        <section class="custom-header">
            <div class="header-text">
                <h1>Mini Galletas <br><span>Artesanales</span></h1>
                <p>
                    Crujientes por fuera y suaves por dentro. Horneadas diariamente con ingredientes 
                    de la más alta calidad. Escoge tu sabor favorito para endulzar tus reuniones.
                </p>
            </div>
        </section>
        ...
        <div class="configurator-grid">
            ...
            <div class="preview-panel">
                <img id="previewCake" src="imagenes/productos/mini-galletas.png" alt="Mini Galletas El Lado Dulce">
            </div>
            ...
            <div class="options-panel">
                ...
                <div class="category">
                    ...
                    <div class="cards" id="saborContainer">
                        ...
                        <div class="card" data-value="Doble Chocolate">
            ...
            <div class="summary-panel">
                ...
                <div class="summary-item">
                    <span>Sabor:</span>
                    <strong id="resumenSabor">Chispas de Chocolate</strong>
                </div>
                <div class="summary-item">
                    <span>Empaque:</span>
                    <strong id="resumenTopping">Caja Estándar</strong>
                </div>
                ...
                <div class="summary-price">
                    <span>Total:</span>
                    <span id="totalPrice" style="color: #ff4f8b;">$8.50</span>
                </div>
