...
<head>
    ...
    <title>Alfajores de Maicena | El Lado Dulce</title>
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    ...
                    <p class="product-description">
                        Rellenos de abundante dulce de leche y borde de coco rallado.
                        Mínimo 12 unidades por pedido. Un clásico irresistible.
                    </p>
                </div>

                <form class="order-form" id="orderForm" data-base-price="9.50">
                    ...
                    <section class="option-box">
                        ...
                        <div class="flavor-options">
                            <label class="flavor-card selected">
                                <input type="radio" name="sabor" value="Dulce de Leche" checked>
                    ...
                    <section class="option-box">
                        <h2>2. Agrega cobertura <span>(opcional)</span></h2>
                        <p class="option-note">Puedes agregar más de uno.</p>

                        <div class="topping-grid">
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Coco rallado extra" data-price="0.50">
                                <span>Coco rallado extra</span>
                                <strong>+$0.50</strong>
                            </label>
                            ...
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Almendras fileteadas" data-price="1.00">
                                <span>Almendras fileteadas</span>
                                <strong>+$1.00</strong>
                            </label>
                        </div>
                    </section>
                    ...
                    <section class="option-box">
                        ...
                        <textarea id="notas" placeholder="Ej: extra dulce de leche, sin coco..."></textarea>
                    </section>

                    <section class="summary-box">
                        <div>
                            <span>Subtotal</span>
                            <strong id="subtotalPrice">$9.50</strong>
