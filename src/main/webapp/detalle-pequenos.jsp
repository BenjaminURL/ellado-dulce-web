...
<head>
    ...
    <title>Mini Empanaditas | El Lado Dulce</title>
    ...
    <main class="product-page">
        ...
        <section class="product-detail">
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    <h1>Mini Empanaditas</h1>
                    <p class="product-price">$18.00</p>
                    <p class="product-description">
                        Masa horneada crujiente rellenas de carne molida, pollo desmechado o queso.
                        Mínimo 20 unidades por pedido. Perfectas para eventos.
                    </p>
                </div>

                <form class="order-form" id="orderForm" data-base-price="18.00">

                    <section class="option-box">
                        <h2>1. Elige el relleno</h2>

                        <div class="flavor-options">
                            <label class="flavor-card selected">
                                <input type="radio" name="sabor" value="Carne molida" checked>
                                <span class="flavor-circle"></span>
                                <small>Carne molida</small>
                            </label>

                            <label class="flavor-card">
                                <input type="radio" name="sabor" value="Pollo desmechado">
                                <span class="flavor-circle"></span>
                                <small>Pollo desmechado</small>
                            </label>

                            <label class="flavor-card">
                                <input type="radio" name="sabor" value="Queso">
                                <span class="flavor-circle"></span>
                                <small>Queso</small>
                            </label>
                    ...
                    <section class="option-box">
                        <h2>2. Agrega salsas <span>(opcional)</span></h2>
                        <p class="option-note">Puedes agregar más de una.</p>

                        <div class="topping-grid">
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Salsa de ají" data-price="1.00">
                                <span>Salsa de ají</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Salsa de yogur" data-price="1.00">
                                <span>Salsa de yogur</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Salsa de tomate" data-price="0.50">
                    ...
                    <section class="option-box quantity-box">
                        ...
                        <p style="font-size: 12px; color: #b0aec4; margin-top: 10px;">Mínimo 20 unidades</p>
                    </section>

                    <section class="option-box">
                        <h2>4. Notas especiales <span>(opcional)</span></h2>

                        <textarea id="notas" placeholder="Ej: sin picante, bien cocidas..."></textarea>
                    </section>

                    <section class="summary-box">
                        <div>
                            <span>Subtotal</span>
                            <strong id="subtotalPrice">$18.00</strong>
        ...
        <section class="related-section">
            ...
            <div class="related-grid">
                ...
                <article class="related-card">
                    <div class="related-img placeholder"></div>
                    <h3>Canapés Gourmet</h3>
                    <p>Base de pan tostado con combinaciones elegantes.</p>
                    <strong>$22.00</strong>
                    <a href="detalle-canapes.jsp">Ver más</a>
                </article>
