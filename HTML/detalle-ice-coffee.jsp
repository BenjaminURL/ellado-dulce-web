...
<head>
    ...
    <title>Ice Coffee | Ellado Dulce</title>

    <!-- Fuente Poppins -->
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">

    <!-- CSS propio de Ice Coffee -->
    <link rel="stylesheet" href="../css/detalle-ice-coffee.css">
</head>
...
<body>
        ...
        <main class="detalle-producto">
            ...
            <section class="detalle-grid">
                ...
                <section class="producto-info">
                    ...
                    <p class="descripcion">
                        Café espresso servido con hielo y leche. Una bebida fría,
                        ligera y perfecta para acompañar crepes, helados o postres.
                    </p>
    ...
    <script src="detalle-ice-coffee.js"></script>
