...
<head>
    ...
    <title>Frappe Mocca | Ellado Dulce</title>

    <!-- Fuente Poppins -->
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">

    <!-- CSS propio de Ice Coffee -->
    <link rel="stylesheet" href="/css/detalle-frappe-m.css">
</head>
...
<body>
        ...
        <main class="detalle-producto">
            ...
            <section class="detalle-grid">
                ...
                <section class="producto-info">
                    ...
                    <p class="descripcion">
                         Bebida fría y cremosa preparada con café, chocolate y hielo triturado. 
                         Una opción dulce e intensa para los amantes del mocca
                    </p>
    ...
    <!-- Js conexion -->
    <script src="detalle-frappe-m.js"></script>
