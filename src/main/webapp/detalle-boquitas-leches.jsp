...
<head>
    ...
    <title>Mini Tres Leches | El Lado Dulce</title>
    ...
    <main>
        ...
        <section class="custom-header">
            <div class="header-text">
                ...
                <p>
                    Nuestros clásicos e irresistibles postres en formato miniatura, perfectamente húmedos 
                    y servidos en vasitos individuales para tus eventos. 
                </p>
            </div>
        </section>
        ...
        <div class="configurator-grid">
            ...
            <div class="options-panel">
                ...
                <div class="category">
                    ...
                    <div class="cards" id="saborContainer">
                        ...
                        <div class="card" data-value="Chocolate">
                            <strong>Chocolate (Remojo de 3 leches con toque de cacao)</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="category">
                    ...
                    <div class="cards" id="toppingContainer">
                        ...
                        <div class="card" data-value="Chantilly con Hilos de Caramelo">
                            <strong>Base Chantilly con Hilos de Dulce de Leche</strong>
                        </div>
                        <div class="card" data-value="Chantilly con Virutas de Chocolate">
                            <strong>Base Chantilly con Virutas de Chocolate Amargo</strong>
                        </div>
                    </div>
                </div>
            ...
            <div class="summary-panel">
                ...
                <div class="summary-item">
                    ...
                    <strong id="resumenTopping">Chantilly con Canela</strong>
                </div>
                ...
                <div class="summary-price">
                    <span>Total:</span>
                    <span id="totalPrice" style="color: #ff4f8b;">$18.00</span>
                </div>
