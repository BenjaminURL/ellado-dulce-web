...
<head>
    ...
    <title>Pastel de Cumpleaños | El Lado Dulce</title>
        ...
        <section class="product-detail">
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    ...
                    <p class="product-price">Desde $22.50</p>
                    <p class="product-description">
                        Clásico, festivo y espectacular. El pastel perfecto para hacer memorable cada año que se celebra, 
                        con un sabor suave y una decoración hecha para brillar en tu mesa de fiesta.
                    </p>
                </div>

                <form class="order-form" id="orderForm" data-base-price="22.50">
                    ...
                    <section class="option-box">
                        <h2>2. Agregados para la fiesta <span>(opcional)</span></h2>
                        <p class="option-note">Completa el pastel con todo lo necesario para cantar el cumpleaños.</p>

                        <div class="topping-grid">
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Velas Magicas" data-price="1.00">
                                <span>Velas Mágicas</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Topper HB" data-price="2.00">
                                <span>Letrero "Happy Birthday"</span>
                                <strong>+$2.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Vela Sparkler" data-price="1.50">
                                <span>Vela de Bengala / Volcán</span>
                                <strong>+$1.50</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Macarons" data-price="3.00">
                                <span>Macarons Extra (4 uds)</span>
                                <strong>+$3.00</strong>
                            </label>
                        </div>
                    </section>
                    ...
                    <section class="option-box">
                        <h2>4. Mensaje en el pastel y detalles <span>(opcional)</span></h2>

                        <textarea id="notas" placeholder="Ej: Escribir 'Feliz Cumpleaños Mamá', agregar el número 30, etc..."></textarea>
                    </section>

                    <section class="summary-box">
                        <div>
                            <span>Subtotal</span>
                            <strong id="subtotalPrice">$22.50</strong>
        ...
        <section class="related-section">
            ...
            <div class="related-grid">
                ...
                <article class="related-card">
                    ...
                    <p>Elegante y sencillo para celebraciones modernas.</p>
                    <strong>$19.99</strong>
                    <a href="detalle-pastel-minimalista.jsp">Ver más</a>
                </article>

                <article class="related-card">
                    <div class="related-img placeholder"></div>
                    <h3>Pastel Infantil</h3>
                    <p>Colorido y divertido para los más pequeños.</p>
                    <strong>$24.50</strong>
