...
<head>
    ...
    <title>Dibujo | Ellado Dulce</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="detalle-dibujo.css">
</head>
<body>
    ...
    <main class="detalle-page">
        ...
        <section class="detalle-layout">
            ...
            <div class="info-area">
                ...
                <div class="price">
                    <strong>Desde $12</strong>
                    <span>/ persona</span>
                </div>

                <p class="description">
                    Desarrolla tu creatividad aprendiendo técnicas básicas de dibujo,
                    trazos, sombreado y composición. Una actividad ideal para niños,
                    jóvenes o adultos que desean expresarse por medio del arte.
                </p>
                ...
                <section class="option-box">
                    ...
                    <div class="schedule-options">
                        <button type="button" class="schedule-option selected" data-horario="Sábado 2:00 p.m.">
                            <strong>Sábado</strong>
                            <small>2:00 p.m.</small>
                        </button>

                        <button type="button" class="schedule-option" data-horario="Domingo 3:00 p.m.">
                ...
                <section class="option-box">
                    ...
                    <input 
                        type="text" 
                        id="notas" 
                        placeholder="Ej: edad del participante, preferencias, algún comentario..."
                    >
                </section>
                ...
                <section class="summary-box">
                    <div class="summary-top">
                        ...
                        <div class="summary-price">
                            <strong id="subtotal">$12.00</strong>
                    ...
                    <div class="confirmation-box hidden" id="confirmationBox">
                        ...
                        <strong id="confirmationNumber">ED-DIB-0000</strong>
    ...
    <script src="detalle-dibujo.js"></script>
</body>
</html>