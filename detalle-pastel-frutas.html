...
<head>
    ...
    <title>Pastel de Frutas | El Lado Dulce</title>
        ...
        <section class="product-detail">
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    <h1>Pastel de Frutas</h1>
                    <p class="product-price">Desde $26.50</p>
                    <p class="product-description">
                        Pastel fresco con crema pastelera y frutas de temporada.
                        Una opción ligera, colorida y llena de sabor.
                    </p>
                </div>

                <form class="order-form" id="orderForm" data-base-price="26.50">
                    ...
                    <section class="option-box">
                        <h2>2. Elige tus frutas <span>(opcional)</span></h2>
                        <p class="option-note">Puedes elegir más de una.</p>

                        <div class="topping-grid">
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Fresa" data-price="1.00">
                                <span>Fresa</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Kiwi" data-price="1.00">
                                <span>Kiwi</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Mango" data-price="1.00">
                                <span>Mango</span>
                                <strong>+$1.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Arándanos" data-price="1.50">
                                <span>Arándanos</span>
                                <strong>+$1.50</strong>
                            </label>
                        </div>
                    ...
                    <section class="option-box">
                        ...
                        <textarea id="notas" placeholder="Ej: sin frutos secos, mensaje especial..."></textarea>
                    </section>

                    <section class="summary-box">
                        <div>
                            <span>Subtotal</span>
                            <strong id="subtotalPrice">$26.50</strong>
        ...
        <section class="related-section">
            ...
            <div class="related-grid">
                ...
                <article class="related-card">
                    ...
                    <p>Terciopelo rojo con crema de queso.</p>
                    <strong>$24.00</strong>
