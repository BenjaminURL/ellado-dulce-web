...
<head>
    ...
    <title>Pastel de Vainilla | El Lado Dulce</title>
        ...
        <section class="product-detail">
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    ...
                    <p class="product-price">Desde $19.99</p>
                    <p class="product-description">
                        Esponjoso pastel de vainilla con relleno cremoso de buttercream.
                        Perfecto para cumpleaños y celebraciones especiales.
                    </p>
                </div>

                <form class="order-form" id="orderForm" data-base-price="19.99">
                    ...
                    <section class="option-box">
                        ...
                        <div class="flavor-options">
                            ...
                            <label class="flavor-card">
                                <input type="radio" name="presentacion" value="Corazon">
                                <span class="flavor-circle"></span>
                                <small>Corazón</small>
                            </label>
                        </div>
                    ...
                    <section class="option-box">
                        ...
                        <div class="topping-grid">
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Fondant" data-price="3.00">
                                <span>Fondant</span>
                                <strong>+$3.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Flores comestibles" data-price="2.00">
                                <span>Flores comestibles</span>
                                <strong>+$2.00</strong>
                            </label>

                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Mensaje personalizado" data-price="1.50">
                    ...
                    <section class="summary-box">
                        <div>
                            <span>Subtotal</span>
                            <strong id="subtotalPrice">$19.99</strong>
        ...
        <section class="related-section">
            ...
            <div class="related-grid">
                <article class="related-card">
                    ...
                    <p>Chocolate intenso con ganache belga.</p>
                    <strong>$22.50</strong>
