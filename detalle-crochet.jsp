...
<head>
    ...
    <title>Crochet | Ellado Dulce</title>

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="detalle-crochet.css">
</head>
<body>
        ...
        <section class="detalle-layout">
            ...
            <div class="info-area">
                ...
                <p class="description">
                    ...
                    figuras, accesorios y más. Ideal para relajarte, crear y llevarte a casa
                    pequeñas obras hechas por ti en un ambiente amigable y creativo.
                </p>
                ...
                <section class="option-box">
                    ...
                    <div class="schedule-options">
                        <button type="button" class="schedule-option selected" data-horario="Sábado 10:00 a.m.">
                            <strong>Sábado</strong>
                            <small>10:00 a.m.</small>
                        </button>

                        <button type="button" class="schedule-option" data-horario="Domingo 11:00 a.m.">
                ...
                <section class="option-box">
                    ...
                    <div class="level-options">
                        ...
                        <button type="button" class="level-option" data-nivel="Intermedio">
                            Intermedio
                        </button>
                    </div>
                </section>
                ...
                <section class="option-box">
                    ...
                    <input 
                        type="text" 
                        id="notas" 
                        placeholder="Ej: alergias, preferencias, algún comentario..."
                    >
                </section>
                ...
                <section class="summary-box">
                    ...
                    <div class="confirmation-box hidden" id="confirmationBox">
                        ...
                        <strong id="confirmationNumber">ED-CRO-0000</strong>
            ...
            <div class="related-grid">
                ...
                <article class="related-card">
                    ...
                    <div class="related-content">
                        <h3>Dibujo</h3>
                        <p>
                            Descubre tu creatividad aprendiendo técnicas de dibujo,
                            sombreado y perspectiva con materiales variados.
                        </p>
                ...
                <article class="related-card">
                    ...
                    <div class="related-content">
                        ...
                        <p>
                            ...
                            Ideal para crear detalles dulces.
                        </p>
    ...
    <script src="detalle-crochet.js"></script>
</body>
</html>