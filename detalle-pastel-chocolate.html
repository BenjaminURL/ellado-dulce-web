...
<head>
    ...
    <title>Pastel de Chocolate | El Lado Dulce</title>
            ...
            <div class="product-config">
                ...
                <div class="product-header">
                    ...
                    <p class="product-description">
                        Pastel de chocolate intenso con ganache de chocolate belga.
                        Una experiencia irresistible para los amantes del cacao.
                    </p>
                </div>
                ...
                <form class="order-form" id="orderForm" data-base-price="22.50">
                    ...
                    <section class="option-box">
                        ...
                        <div class="topping-grid">
                            ...
                            <label class="topping-option">
                                <input type="checkbox" class="topping-checkbox" value="Chispas de chocolate" data-price="1.50">
