...
<header class="navbar">
    ...
    <nav class="menu">
        ...
        <div class="dropdown">
            <a href="Pasteles.jsp" class="dropdown-toggle">
...
<section class="cake-hero">
    ...
    <div class="cake-info">
        ...
        <div class="cake-buttons">
            <a href="https://wa.me/5073158752?text=Hola,%20quiero%20cotizar%20un%20pastel." 
               target="_blank" 
               class="btn-whatsapp">
    ...
    <div class="cake-image">
        <img src="imagenes/Pasteles/pasrandom.png" alt="Pastel principal">
    </div>
    ...
    try {
        ...
        while (rs.next()) {
            ...
            if (descripcion == null || descripcion.trim().equals("")) {
                descripcion = "Pastel especial de El Lado Dulce, ideal para celebraciones y momentos especiales.";
            }

            String precioTexto = String.format(java.util.Locale.US, "%.2f", precio);
            String imagenPastel = "imagenes/Pasteles/" + producto + "-" + idMenu + ".png";
%>

        <div class="cake-card">
            <img src="<%= imagenPastel %>" alt="<%= producto %>">
            ...
            <div class="cake-content">
                ...
                <a href="detalle-pastel.jsp?id=<%= idMenu %>">Ver más</a>
            </div>
        </div>
...
%>
        ...
        <p>Error al cargar los pasteles.</p>
